...
class DslProcessor(
    ...
    private fun generate(spec: KSClassDeclaration) {
    ...
    private class Checker(private val logger: KSPLogger) {
        ...
        fun validator(
            ...
            val dslValidatorType = declaration.findSuperType(DSL_VALIDATOR_NAME)
        ...
        fun mapper(
            ...
            val dslMapperType = declaration.findSuperType(DSL_MAPPER_NAME)
        ...
        private fun KSClassDeclaration.findSuperType(qualifiedName: String): KSType? {
            for (superType in superTypes) {
                val resolved = superType.resolve()
                if (resolved.declaration.qualifiedName?.asString() == qualifiedName) return resolved
                (resolved.declaration as? KSClassDeclaration)?.findSuperType(qualifiedName)?.let { return it }
            }
            return null
        }
    }
